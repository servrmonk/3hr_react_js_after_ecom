      ...
      <Card>
        {medsDet.length > 0 &&
          medsDet.map((prod, index) => (
            <div key={index}>
              <Card.Header as="h5">Shoe Name: {prod.medicineName}</Card.Header>
              <Card.Body>
                <Card.Title>Shoe Description: {prod.medicineDesc}</Card.Title>
                <Card.Text>Shoe Price:{prod.medicinePrice}</Card.Text>
