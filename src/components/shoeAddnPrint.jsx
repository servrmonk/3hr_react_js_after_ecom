  ...
  return (
    <Form className="setForm" onSubmit={submitHadler} >
      <Form.Group>
        ...
        <Form.Control name="medName" value={prod.medName} onChange={changeHandler}  placeholder="Enter Shoe Name" />
      </Form.Group>

      <Form.Group>
        <Form.Label>Description</Form.Label>
        <Form.Control name="medDes" value={prod.medDes} onChange={changeHandler} placeholder="Enter Shoe Description" />
      </Form.Group>
